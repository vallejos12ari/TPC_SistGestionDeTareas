<%@ Page Title="Tags" Language="C#" MasterPageFile="~/MasterPages/Site.Master"
    AutoEventWireup="true" CodeBehind="Listar.aspx.cs"
    Inherits="Web.Pages.Tags.Listar" %>

<asp:Content ID="ContenidoTags" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HiddenField ID="IdTagAEliminar" runat="server" />

    <asp:GridView ID="TablaTags" runat="server"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ¿Seguro querés eliminar este tag?
                </div>
    ...
    <script>
        function AbrirModalEliminar(id) {
            document.getElementById("<%= IdTagAEliminar.ClientID %>").value = id
