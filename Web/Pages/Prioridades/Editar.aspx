<%@ Page Title="Editar Prioridad" Language="C#" MasterPageFile="~/MasterPages/Site.Master"
    AutoEventWireup="true" CodeBehind="Editar.aspx.cs"
    Inherits="Web.Pages.Prioridades.Editar" %>

<asp:Content ID="ContenidoEditar" ContentPlaceHolderID="MainContent" runat="server">

    <h3 class="fw-bold mb-4">Editar prioridad</h3>

    <asp:HiddenField ID="IdPrioridadHidden" runat="server" />
