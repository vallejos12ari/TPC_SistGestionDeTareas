<%@ Page Title="Crear Prioridad" Language="C#" MasterPageFile="~/MasterPages/Site.Master"
    AutoEventWireup="true" CodeBehind="Crear.aspx.cs"
    Inherits="Web.Pages.Prioridades.Crear" %>

<asp:Content ID="ContenidoCrear" ContentPlaceHolderID="MainContent" runat="server">

    <h3 class="fw-bold mb-4">Crear prioridad</h3>
